...
public class SuggestionAdapter extends BaseAdapter implements Filterable {
    ...
    private List<SuggestionsData> suggestionsList;
    ...
    @Override
    public SuggestionsData getItem(int position) {
    ...
    private static class ViewHolder {
        ...
        public void bind(SuggestionsData item) {
    ...
    private class SuggestionFilter extends Filter {
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            ...
            suggestionsList = (List<SuggestionsData>) results.values;
            if (results.count > 0) {
        ...
        public CharSequence convertResultToString(Object resultValue) {
            return ((SuggestionsData) resultValue).getKey();
        }
    }
}
